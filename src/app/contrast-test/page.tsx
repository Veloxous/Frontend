    ...
    <main style={{ maxWidth: 1080, margin: '0 auto', padding: '48px 32px' }}>
      ...
      <section style={{ marginBottom: 40 }}>
        ...
        <div style={{ 
          ...
          <div style={{ 
            ...
            Credit Score: 88 → 92{' '}
            <span style={{ color: 'var(--growth)', fontWeight: 600 }}>↑</span>
          </div>
          ...
          <div style={{ 
            ...
            Green Impact: 76 → 71{' '}
            <span style={{ color: 'var(--ember)', fontWeight: 600 }}>↓</span>
          </div>
        </div>
      </section>
      ...
      <section style={{ marginBottom: 40 }}>
        ...
        <div style={{ 
          ...
          <p style={{ fontFamily: 'var(--font-body)', fontSize: 16, color: 'var(--ink-60)', margin: 0 }}>
            Secondary text using --ink-60 (improved from 0.62 to 0.68)
          </p>
          <p style={{ fontFamily: 'var(--font-body)', fontSize: 16, color: 'var(--ink-40)', margin: 0 }}>
            Tertiary text using --ink-40 (improved from 0.42 to 0.50)
          </p>
          <p style={{ fontFamily: 'var(--font-data)', fontSize: 13, color: 'var(--ink-40)', margin: 0 }}>
      ...
      <section>
        ...
        <div style={{ 
          ...
          <div style={{ marginBottom: 12 }}>
            <strong style={{ color: 'var(--ink)' }}>Normal text (&lt;18px or &lt;14px bold):</strong>{' '}
          ...
          <div style={{ marginBottom: 16 }}>
            <strong style={{ color: 'var(--ink)' }}>Non-text elements:</strong>{' '}
            Requires 3:1 contrast
          </div>
      ...
      <section style={{ marginTop: 40, padding: 24, background: 'var(--solar-12)', borderRadius: 'var(--radius-card)', border: '1px solid var(--solar-24)' }}>
        <h3 style={{ 
          fontFamily: 'var(--font-display)', 
          fontSize: 18, 
          fontWeight: 700, 
