...
This guide defines the design tokens, brand rules, and patterns that make the Heliobond interface *warm, lucid, and alive*. Use this as a single source of truth when extending the design system or implementing new features.
